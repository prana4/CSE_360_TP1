...
public class ViewUserUpdate {
	...
	private ViewUserUpdate() {
		...
		label_Purpose.setStyle("-fx-text-fill: #34495e;");

		// Static labels
		label_Username.setStyle("-fx-text-fill: #555;");
		label_Password.setStyle("-fx-text-fill: #555;");
		label_FirstName.setStyle("-fx-text-fill: #555;");
		label_MiddleName.setStyle("-fx-text-fill: #555;");
		label_LastName.setStyle("-fx-text-fill: #555;");
		label_PreferredFirstName.setStyle("-fx-text-fill: #555;");
		label_EmailAddress.setStyle("-fx-text-fill: #555;");

		// Dynamic value labels
		label_CurrentUsername.setStyle("-fx-text-fill: #2c3e50;");
		label_CurrentPassword.setStyle("-fx-text-fill: #2c3e50;");
		label_CurrentFirstName.setStyle("-fx-text-fill: #2c3e50;");
		label_CurrentMiddleName.setStyle("-fx-text-fill: #2c3e50;");
		label_CurrentLastName.setStyle("-fx-text-fill: #2c3e50;");
		label_CurrentPreferredFirstName.setStyle("-fx-text-fill: #2c3e50;");
		label_CurrentEmailAddress.setStyle("-fx-text-fill: #2c3e50;");

		// Buttons (flat green, rounded corners, hover effect)
		...
		String hoverButtonStyle =
		    "-fx-background-color: #596b59; " +
		    "-fx-text-fill: white; " +
		    "-fx-background-radius: 8;";

		// Apply to all update buttons
		Button[] updateButtons = {
		    button_UpdateUsername,
		    button_UpdatePassword,
		    button_UpdateFirstName,
		    button_UpdateMiddleName,
		    button_UpdateLastName,
		    button_UpdatePreferredFirstName,
		    button_UpdateEmailAddress,
		};

		for (Button b : updateButtons) {
		    b.setStyle(baseButtonStyle);
		    b.setOnMouseEntered(e -> b.setStyle(hoverButtonStyle));
		    b.setOnMouseExited(e -> b.setStyle(baseButtonStyle));
		}

		

		button_ProceedToUserHomePage.setStyle(
		    "-fx-background-color: #f2d58c; " +
		    "-fx-text-fill: black; " +
		    "-fx-background-radius: 8;"
		);
		
		button_ProceedToUserHomePage.setOnMouseEntered(e -> button_ProceedToUserHomePage.setStyle("-fx-background-color: #e8c469; -fx-text-fill: black; -fx-background-radius: 8;"));
		button_ProceedToUserHomePage.setOnMouseExited(e -> button_ProceedToUserHomePage.setStyle("-fx-background-color: #f2d58c; -fx-text-fill: black; -fx-background-radius: 8;"));
		...
		setupLabelUI(label_ApplicationTitle, "Times New Roman", 28, width, Pos.CENTER, 0, 5);

        // Label to display the welcome message for the first theUser
        setupLabelUI(label_Purpose, "Times New Roman", 20, width, Pos.CENTER, 0, 50);
