...
public class ViewAdminHome {
	...
	*/
	...
	private ViewAdminHome() {
		...
		// Title and user info
		label_PageTitle.setStyle("-fx-text-fill: #2c3e50; -fx-font-weight: bold;");
		label_UserDetails.setStyle("-fx-text-fill: #34495e;");

		// System status labels
		label_NumberOfInvitations.setStyle("-fx-text-fill: #555;");
		label_NumberOfUsers.setStyle("-fx-text-fill: #555;");

		// Invitation section labels + text field
		label_Invitations.setStyle("-fx-text-fill: #2c3e50; -fx-font-weight: bold;");
		label_InvitationEmailAddress.setStyle("-fx-text-fill: #555;");

		text_InvitationEmailAddress.setStyle(
		...
		String baseButtonStyle = 
		    "-fx-background-color: #5377b2; " +
		    "-fx-text-fill: white; " +
		    "-fx-background-radius: 8;";

		String hoverBlue =
		    "-fx-background-color: #9bb8c9; " +
		    "-fx-text-fill: white; " +
		    "-fx-background-radius: 8;";

		String baseGreen =
		    "-fx-background-color: #a3d8a7; " +
		    "-fx-text-fill: black; " +
		    "-fx-background-radius: 8;";

		String hoverGreen =
		    "-fx-background-color: #9ace9e; " +
		    "-fx-text-fill: black; " +
		    "-fx-background-radius: 8;";

		String baseYellow =
		    "-fx-background-color: #e8c469; " +
		    "-fx-text-fill: black; " +
		    "-fx-background-radius: 8;";
		...
		for (Button b : blueButtons) {
		    b.setStyle(baseButtonStyle);
		    b.setOnMouseEntered(e -> b.setStyle(hoverBlue));
		    b.setOnMouseExited(e -> b.setStyle(baseButtonStyle));
		}

		// Green (optional for positive actions)
		button_UpdateThisUser.setStyle(baseGreen);
		button_UpdateThisUser.setOnMouseEntered(e -> button_UpdateThisUser.setStyle(hoverGreen));
		button_UpdateThisUser.setOnMouseExited(e -> button_UpdateThisUser.setStyle(baseGreen));

		// Logout button → green
		button_Logout.setStyle(baseGreen);
		button_Logout.setOnMouseEntered(e -> button_Logout.setStyle(hoverGreen));
		button_Logout.setOnMouseExited(e -> button_Logout.setStyle(baseGreen));

		// Quit button → red
		button_Quit.setStyle(baseYellow);
		button_Quit.setOnMouseEntered(e -> button_Quit.setStyle(hoverYellow));
		button_Quit.setOnMouseExited(e -> button_Quit.setStyle(baseYellow));
