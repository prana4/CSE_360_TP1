...
public class ViewNewAccount {
	...
	*/
	...
	private ViewNewAccount() {
		...
		// Style for username and password text fields
		...
		// Apply to buttons
		button_UserSetup.setStyle(baseGreen);
		button_UserSetup.setOnMouseEntered(e -> button_UserSetup.setStyle(hoverGreen));
		button_UserSetup.setOnMouseExited(e -> button_UserSetup.setStyle(baseGreen));
       ...
       setupButtonUI(button_Quit, "Dialog", 18, 150, Pos.CENTER, 500, 540);
