...
public class ViewRole2Home {
	...
	private ViewRole2Home() {
		...
		//==============CSS=================
				...
				// Account Update
				button_UpdateThisUser.setStyle(
				    "-fx-background-color: #a3d8a7; " +   // green
				    "-fx-text-fill: black; " +
				...
				button_UpdateThisUser.setOnMouseEntered(e ->
				    button_UpdateThisUser.setStyle(
				        "-fx-background-color: #9ace9e; " +   // darker green
				        "-fx-text-fill: black; " +
				        "-fx-background-radius: 8; " +
				        "-fx-border-color: #ffffff; " +
				        "-fx-border-radius: 8; " +
				...
				button_UpdateThisUser.setOnMouseExited(e ->
				    button_UpdateThisUser.setStyle(
				...
				button_Logout.setStyle(
				    "-fx-background-color: #758c75; " +   // green-gray
				    "-fx-text-fill: white; " +
				    "-fx-background-radius: 8; " +
				    "-fx-border-color: #ffffff; " +
				    "-fx-border-radius: 8; " +
				...
				button_Logout.setOnMouseEntered(e ->
				    button_Logout.setStyle(
				...
				button_Logout.setOnMouseExited(e ->
				    button_Logout.setStyle(
				...
				button_Quit.setStyle(
				    "-fx-background-color: #e8c469; " +   // yellow
				    "-fx-text-fill: black; " +
				    "-fx-background-radius: 8; " +
				    "-fx-border-color: #ffffff; " +
				    "-fx-border-radius: 8; " +
				...
				button_Quit.setOnMouseEntered(e ->
				    button_Quit.setStyle(
				        "-fx-background-color: #e8c469; " +   // darker yellow
				        "-fx-text-fill: black; " +
				        "-fx-background-radius: 8; " +
				        "-fx-border-color: #ffffff; " +
				        "-fx-border-radius: 8; " +
